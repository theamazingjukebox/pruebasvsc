...
(function() {
  ...
  async function openMiniPlayer() {
    try {
      ...
      pipWindow.document.body.innerHTML = `
        ...
        <img id="mini-jukebox-animation" src="Copia de Copia de Copia de Sin título (1).gif" alt="Jukebox"> 
        </div>
  ...
  function dismissBanner() {
    ...
    preloadJukeboxAnim.src = 'Copia de Copia de Copia de Sin título (1).gif'; 
